...
def create_training_options():
    ...
    parser.add_argument("--name",           type=str,   default='',        help="experiment ID")
    parser.add_argument("--ckpt",           type=str,   default='',        help="resumed checkpoint name")
    ...
    parser.add_argument("--corrupt",        type=str,   default='SR',        help="restoration task")
    parser.add_argument("--t0",             type=float, default=1e-4,        help="sigma start time in network parametrization")
    parser.add_argument("--T",              type=float, default=1.,          help="sigma end time in network parametrization")
    parser.add_argument("--interval",       type=int,   default=1000,        help="number of interval")
    parser.add_argument("--beta-max",       type=float, default=0.3,         help="max diffusion for the diffusion model")
    # parser.add_argument("--beta-min",       type=float, default=0.1)
    parser.add_argument("--ot-ode",         default=True,             help="use OT-ODE model")#action="store_true",
    ...
    parser.add_argument("--lr",             type=float, default=5e-7,        help="learning rate")#5e-8
    parser.add_argument("--lr_fake",        type=float, default=5e-6,        help="learning rate")#5e-5
    ...
    # --------------- path and logging ---------------
    parser.add_argument("--train_dataset_dir",    type=Path,  default="",  help="path to LMDB dataset")
    parser.add_argument("--val_dataset_dir",    type=Path,  default="",  help="path to LMDB dataset")

    parser.add_argument("--log-dir",        type=Path,  default="",      help="path to log std outputs and writer data")
    parser.add_argument("--log-writer",     type=str,   default="tensorboard",        help="log writer: can be tensorbard, wandb, or None")
